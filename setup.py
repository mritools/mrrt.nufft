...
def get_version_info():
    ...
    # write_version_py(), otherwise the import pyir.nufft.version messes
    # up the build under Python 3.
    FULLVERSION = VERSION
    if os.path.exists('.git'):
        GIT_REVISION = git_version()
    elif os.path.exists('pyir/nufft/version.py'):
        # must be a source distribution, use existing version file
        # load it as a separate module to not load pyir/nufft/__init__.py
        import imp
        version = imp.load_source('pyir.nufft.version', 'pyir/nufft/version.py')
...
def write_version_py(filename='pyir/nufft/version.py'):
    cnt = """
