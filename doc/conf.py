...
version = source_version.split('+')[0]
...
latex_documents = [
  ('index', 'pyir.nufft.tex', 'pyir.nufft Documentation',
...
man_pages = [
    ('index', 'pyir.nufft', 'pyir.nufft Documentation',
     ['Gregory R. Lee'], 1)
]
...
texinfo_documents = [
  ('index', 'pyir.nufft', 'pyir.nufft Documentation',
   'Gregory R. Lee', 'pyir.nufft', 'One line description of project.',
   'Miscellaneous'),
]
